...
<div class="invoice-box">
    <div class="d-flex justify-content-between mb-4">
        ...
        <div class="text-end d-print-none">
            ...
            <?php } else { ?>
                <a href="direct_sale_approve.php?invoice_id=<?= $invoice_no ?>&cus_id=<?= $info['cus_id'] ?>&due=<?= $total_due ?>" 
                   class="btn btn-success btn-sm" 
                   onclick="return confirm('Are you sure you want to approve this invoice and update customer due?')">
                   Approve
                </a> 
                <a href="direct_sale_reject.php?invoice_id=<?= $invoice_no ?>" class="btn btn-danger btn-sm">Reject</a> 
            <?php } ?>
        </div>
    </div>
